...
useEffect(()=>{
  axios.get(`https://fakestoreapi.com/products/${id}`).then((sd)=>usefaster(sd.data))
},{})
...
return (
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt={product?.title} className="lg:w-1/2 w-full lg:h-auto max-h-[500px]  h-64 object-cover object-contain rounded" src={product?.image}/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className='flex'>
          <button className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded mr-2" onClick={()=> handleCart(product,true)}>Buy it now</button>
          <button className="flex ml-auto  py-2 px-6 focus:outline-none  rounded oxe1" onClick={()=> handleCart(product)}>Add to cart</button>
          </div>
